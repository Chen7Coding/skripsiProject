        ...
        <div class="bg-white p-6 rounded-lg shadow-sm mb-8 no-print">
            ...
            <form action="{{ route('admin.report.admin_laporan') }}" method="GET"
                ...
                <div class="flex space-x-2">
                    ...
                    {{-- Tombol Reset --}}
                    <a href="{{ route('admin.report.admin_laporan') }}"
                ...
                <div class="flex space-x-2">
                    {{-- URL export menggunakan route helper dengan parameter yang benar --}}
        ...
        <div id="laporan-tabel" class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6 border-b">
                ...
                <form method="GET" class="flex items-center gap-2">
                    ...
                    <span>data</span>
                    {{-- Hidden input agar filter tanggal ikut terbawa --}}
            ...
            {{-- Pagination --}}
            <div class="p-4">
                {{ $orders->appends(request()->query())->fragment('ordersTable')->links() }}
            </div>
        </div>
    </div>
