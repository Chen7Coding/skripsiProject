        ...
        <div class="container mx-auto px-6 pb-16">
            <div class="flex flex-wrap items-start -mx-4">
                <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
                    <img src="{{ asset('image/asset1.jpg') }}" alt="Toko Sidu Digital Print"
                ...
                <div class="w-full md:w-1/2 px-4">
                    ...
                    <p class="text-gray-600 mb-6">
                        Sidu Digital Print adalah solusi terpercaya untuk semua kebutuhan percetakan digital Anda di
                        Majalaya dan sekitarnya. Sejak berdiri pada tahun 2020, kami berkomitmen untuk memberikan kualitas
                        cetak terbaik dengan pelayanan yang cepat, ramah, dan harga yang kompetitif.
                    </p>
