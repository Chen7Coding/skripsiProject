@extends('layouts.owner') {{-- Menggunakan layout owner --}}

@section('title', 'Ubah Password Pemilik')

@section('owner-content') {{-- Sesuaikan dengan nama section di layout owner --}}
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        <div class="mx-auto max-w-xl">

            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800">Ubah Password</h1>
                <p class="mt-1 text-gray-500">Pastikan Anda menggunakan password yang kuat dan mudah diingat.</p>
            </div>
            ...
            @if ($errors->any())
                <div class="mb-6 rounded-md border border-red-400 bg-red-100 px-4 py-3 text-red-700">
                    <ul>
            ...
            <form action="{{ route('owner.profile.password.update') }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div x-data="{ show: false }">
                            ...
                            <div class="relative mt-1">
                                <input :type="show ? 'text' : 'password'" name="current_password" id="current_password"
                                    class="block w-full rounded-md border-gray-300 pr-10 shadow-sm focus:border-amber-500 focus:ring-amber-500 sm:text-sm"
                                    required>
