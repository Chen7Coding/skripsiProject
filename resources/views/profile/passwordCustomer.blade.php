@extends('layouts.dashboard') {{-- Menggunakan layout dashboard pelanggan --}}

@section('title', 'Ubah Password')

@section('dashboard-content') {{-- Sesuaikan dengan nama section di layout dashboard --}}
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        <div class="mx-auto max-w-xl">
            ...
            {{-- Pastikan route ini sudah Anda buat untuk pelanggan: 'profile.password.update' --}}
