                    ...
                    <div x-data="{ open: false }" class="border-b border-gray-200">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-300"
                            ...
                            <div>
                                    ...
                                    @foreach ($order->orderItems as $item)
                                        <li class="flex items-start text-sm text-gray-700">
                                            <div
                                                ...
                                                <img src="{{ asset($item->design_file_path ? 'storage/' . $item->design_file_path : $item->product->image ?? 'https://placehold.co/96x96/E0E0E0/grey?text=No+Image') }}"
                                ...
                                {{-- TOTAL HARGA ITEM DIPINDAHKAN KE BAWAH DAFTAR PRODUK AGAR RAPI 
                                <div class="mt-2 pt-2 border-t border-gray-200 text-right text-lg font-bold text-gray-900">
                                    Subtotal Produk Rp{{ number_format($subtotal, 0, ',', '.') }}</div> --}}
                            ...
                            <div>
                                ...
                                <dl class="space-y-2 text-sm text-gray-700 mt-2">
                                    <div>
                                        <dt class="font-medium">Nama Penerima:</dt>
                                        <dd>{{ $order->name }}</dd>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <dd>{{ $order->address }}, {{ $order->kecamatan }},
                                            {{ $order->shipping_city }},
                                            {{ $order->shipping_province }}, {{ $order->shipping_postal_code }}</dd>
                                    </div>
