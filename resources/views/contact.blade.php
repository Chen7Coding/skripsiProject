    ...
    <div class="bg-white py-16 sm:py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mt-2 text-lg leading-8 text-gray-600">Ada yang bisa kami bantu? Kami menerima pesan kritik dan
            ...
            <form action="{{ route('kirim.pesan') }}" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="topic" class="block text-sm font-semibold leading-6 text-gray-900">Topik
                            Pesan</label>
                        <div class="mt-2.5">
                    ...
                    <div class="sm:col-span-2">
                        <label for="message" class="block text-sm font-semibold leading-6 text-gray-900">Detail
                            Deskripsi</label>
                        <div class="mt-2.5">
                ...
                <div class="mt-10">
                    ...
                    <button type="submit"
                        class="block w-full rounded-md bg-gray-900 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Kirim
                        Pesan</button>
                </div>
            </form>
